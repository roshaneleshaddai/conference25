...
const Header = () => {
  ...
  // <div className="relative w-full h-full">
    <header className={`fixed md:w-full m-auto top-0 z-50 h-30 transition-all duration-300 ease-in-out  bg-[#78B7D0] ${isScrolled ? 'py-0 md:py-2' : 'py-2 md:py-4'}`}>
    {/* <video
    ...
    >
      ...
      <div className="flex items-center justify-around md:p-2">
        ...
        {/* <div className="flex items-center justify-around space-x-0 md:space-x-4"> */}
          <Image
              ...
              loading="lazy"
          />
          <div className={`md:block md:text-center transition-all duration-300 ease-in-out ${isScrolled ? 'text-xs md:text-3xl ' : 'text-xl md:text-4xl'}`}>
      ...
      <div className={`hidden item-center justify-center gap-16 md:flex my-2`}>
        <div className={` items-center text-center flex ${isScrolled ? 'hidden' : 'md:block'}`}>
        <h2 className={`font-bold text-3xl  text-white  ${isScrolled ? 'text-xs md:text-2xl' : 'text-xl md:text-4xl'}`}>
          8<sup>th</sup>   International Conference on Intelligence Computing and <br />Communication ICICC-2025 
            </h2>
            <h2 className={`text-sm text-[#112D32] font-bold ${isScrolled ? 'text-xs md:text-base' : 'text-lg md:text-xl'}`}>
      ...
      <nav className={`hidden md:flex justify-evenly px-24 ${isScrolled ? 'md:mt-0 ' : 'md:mt-6 '} bg-[#FFDC7F]`}>
      <Link
        href="/#home"
        className={`cursor-pointer m-0.5   border-[#1A1A1A]  font-semibold transition-all duration-300 ease-in-out ${isScrolled ? 'text-sm py-1 px-4' : 'text-base py-1 px-2'} hover:bg-[#FF6600]/15  hover:text-black hover:shadow-lg`}
        >
      Home
      </Link>
      <Link
