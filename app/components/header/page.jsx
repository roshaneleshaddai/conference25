...
const Header = () => {
  ...
  // <div className="relative w-full h-full">
    ...
    >
      ...
      <div className="flex items-center justify-around">
        ...
        {/* <div className="flex items-center justify-around space-x-0 md:space-x-4"> */}
          <Image
              ...
              loading="lazy"
          />
          <div className={`md:block md:text-center transition-all duration-300 ease-in-out ${isScrolled ? 'text-base md:text-4xl ' : 'text-xl md:text-4xl'}`}>
      ...
      <Link
        href="/#home"
        className={`cursor-pointer m-0.5   border-[#1A1A1A]  font-semibold transition-all duration-300 ease-in-out ${isScrolled ? 'text-base py-1 px-2' : 'text-xs py-1 px-2'} hover:bg-[#FF6600]/15  hover:text-black hover:shadow-lg`}
        >
      Home
      </Link>
      <Link
      ...
      className={`cursor-pointer m-0.5   border-[#1A1A1A]  font-semibold transition-all duration-300 ease-in-out ${isScrolled ? 'text-base py-1 px-2' : 'text-xs py-1 px-2'} hover:bg-[#FF6600]/15  hover:text-black hover:shadow-lg`}
        ...
        <Link
          href="/schedule"
          className={`cursor-pointer m-0.5   border-[#1A1A1A]  font-semibold transition-all duration-300 ease-in-out ${isScrolled ? 'text-base py-1 px-4' : 'text-xs py-1 px-2'} hover:bg-[#FF6600]/15  hover:text-black hover:shadow-lg`}
        >
          Schedule
        </Link>
        <Link
