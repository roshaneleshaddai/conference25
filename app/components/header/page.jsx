...
const Header = () => {
  ...
  // <div className="relative w-full h-full">
    ...
    >
      ...
      <Link
        href="/#home"
        className={`cursor-pointer m-0.5   border-[#1A1A1A]  font-semibold transition-all duration-300 ease-in-out ${isScrolled ? 'text-sm py-1 ' : 'text-base py-1 px-2'} hover:bg-[#FF6600]/15  hover:text-black hover:shadow-lg`}
        >
      Home
      </Link>
      <Link
