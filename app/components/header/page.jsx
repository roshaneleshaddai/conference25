...
>
  ...
  {/* First set of images */}
  <div className={`flex item-center ${isScrolled ? "flex-col space-y-5 justify-center items-center" : "justify-center items-center space-x-5"}`}>
  ...
  <div className={`flex item-center ${isScrolled ? "flex-col space-y-5 justify-center items-center" : "justify-center items-center space-x-5"}`}>
    ...
    <div className="hidden lg:block">
      ...
      <Link
        href="/#home"
        className={`cursor-pointer m-0.5   border-[#1A1A1A]  font-semibold transition-all duration-300 ease-in-out ${isScrolled ? 'text-sm py-1 px-2' : 'text-sm py-1 px-1'} hover:bg-[#FF6600]/15  hover:text-black hover:shadow-lg`}
        >
      Home
      </Link>
      <Link
      ...
      className={`cursor-pointer m-0.5   border-[#1A1A1A]  font-semibold transition-all duration-300 ease-in-out ${isScrolled ? 'text-sm py-1 px-2' : 'text-sm py-1 px-1'} hover:bg-[#FF6600]/15  hover:text-black hover:shadow-lg`}
        ...
        <Link
          href="/schedule"
          className={`cursor-pointer m-0.5   border-[#1A1A1A]  font-semibold transition-all duration-300 ease-in-out ${isScrolled ? 'text-sm py-1 px-4' : 'text-sm py-1 px-1'} hover:bg-[#FF6600]/15  hover:text-black hover:shadow-lg`}
        >
        Schedule
        </Link>
        <Link
